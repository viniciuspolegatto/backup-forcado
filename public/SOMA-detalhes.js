...
// Preenchendo a tabela de verificação que aparecerá na página STecSenai-dadosContrato 
    ...
    document.getElementById('endereco-td').textContent = `${dataCep.logradouro}, nº ${numeroResidencia} - Bairro: ${dataCep.bairro}; Município de ${dataCep.municipio} - ${dataCep.uf}`;
