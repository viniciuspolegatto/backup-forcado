  ...
  tabelaPrecoForma.innerHTML = `
    ...
    <div>
        ...
        <tr>
           ...
           <td style="border: 1px solid black; padding: 8px">Link de pagamento enviado para compra via cartão de crédito até ${dataFormatadaInicio}, podendo ser parcelado em 10x </td> 
       </tr>
      </table>
    </div>
  `;
