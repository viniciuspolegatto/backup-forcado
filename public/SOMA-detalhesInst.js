...
// Função para CHAVEAMENTO SIM / NÃO e EXPANSÃO DE TABELA
function toggleChave() {
    var chave = document.getElementById("chave");
    var campoAdicional = document.getElementById("campoAdicional");

    if (chave.innerText.trim() === "Não") {
        chave.innerText = "Sim";
        chave.style.backgroundColor = "green";
        campoAdicional.style.display = "block"; // Exibe a tabela de participantes
    } else {
        chave.innerText = "Não";
        chave.style.backgroundColor = "red";
        campoAdicional.style.display = "none"; // Esconde a tabela de participantes
    }
}
// =====================================================================
...
document.getElementById('botaoImpressaoCnpj').addEventListener('click', async function() {
  ...
  let numeroResidencia = document.getElementById('predio').value;
